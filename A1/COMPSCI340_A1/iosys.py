...
class IO_Sys():
    ...
    def fill_buffer(self, process, data):
        ...
        # use iosys buffer as process input buffer
        process.iosys.process_buffers = {"content":data}
        # got input from user, set to continue to run
    ...
    def read(self, process):
        ...
        if process.stoprequest.wait():
            process.stoprequest.clear()
            return process.iosys.process_buffers.pop("content")
